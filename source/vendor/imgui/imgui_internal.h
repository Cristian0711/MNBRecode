...
extern std::unordered_map<ImGuiID, float> checkmark_prog, checkmark_prog_2;
extern std::unordered_map<ImGuiID, int> checkmark_state;
...
namespace ImGui
{
    ...
    IMGUI_API void          RenderCheckMark(ImDrawList* draw_list, ImVec2 pos, ImU32 col, float sz, ImGuiID id=0, bool checked=false);
